...
const SignupComponent = () => {
  ...
  const [isHovering, setIsHovering] = useState(false);
  const [selectedRole, setSelectedRole] = useState<'individual' | 'enterprise'>('individual');
      ...
      <div className='card w-[80%] lg:w-[70%] md:w-[55%] flex justify-between h-[600px]'>
        <div
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                    selectedRole === 'individual'
                      ...
                      : 'bg-[var(--color-surface)] text-[var(--color-text-secondary)] hover:bg-[var(--color-muted-surface)]'
                  } disabled:opacity-50`}
                >
                  Individual
                </button>
          ...
          <div className='hidden lg:block w-1/2 right h-full overflow-hidden rounded-r-lg'>
              <Image
                src='https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1000&h=1000&fit=crop'
                loader={({ src }) => src}
                width={1000}
                height={1000}
                priority
